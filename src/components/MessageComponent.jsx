...
const MessagesComponent = () => {
    ...
    return (
        <div className="lg:flex sm:p-6">
            ...
            <div className={`lg:w-[45%] shadow-md lg:fixed lg:right-4 h-full sm:overflow-auto sm:mt-4  ${show !== null || query.page !== undefined ? 'sm:absolute sm:top-20 bg-white z-10 sm:left-0 sm:h-screen sm:w-screen' : 'sm:hidden'}`}>
